...
namespace DataLabel_Project_BE.Controllers
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        {
            var role = await _authService.GetRoleById(id);
            if (role == null)
            {
        ...
        public async Task<IActionResult> Create([FromBody] CreateRoleRequest request)
        {
            ...
            try
            {
                var newRole = await _authService.CreateRole(request.RoleName);
        ...
        public async Task<IActionResult> Update(Guid id, [FromBody] UpdateRoleRequest request)
        {
            ...
            try
            {
                var role = await _authService.UpdateRole(id, request.RoleName);
                if (role == null)
                {
                    return NotFound(new { message = "Role not found" });
                }
        ...
        public async Task<IActionResult> Delete(Guid id)
        {
            try
            {
                var success = await _authService.DeleteRole(id);
                if (!success)
                {
                    return NotFound(new { message = "Role not found" });
                }
